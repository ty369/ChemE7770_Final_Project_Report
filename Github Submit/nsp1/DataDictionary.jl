...
# Edited based on Varner Lab's original code.
# ------------------------------------------------- #
#
# ----------------------------------------------------------------------------------- #
# Function: DataDictionary
# Description: Holds simulation and model parameters as key => value pairs in a Julia Dict()
# Generated on: 2020-05-13
#
# Input arguments:
...
function DataDictionary(time_start,time_stop,time_step)
	...
	default_bounds_array = [
		...
		0	100.0	;	# 167 GENE_nsp1+RNAP --> OPEN_GENE_nsp1
		0	100.0	;	# 168 transcription_nsp1::
		0	100.0	;	# 169 mRNA_degradation_nsp1:
		0	100.0	;	# 170 mRNA_nsp1+RIBOSOME --> RIBOSOME_START_nsp1
		0	100.0	;	# 171 translation_nsp1
		0	100.0	;	# 172 tRNA_c_charging_M_ala_L_c_nsp1
		0	100.0	;	# 173 (# 168-191 referred to debug file for actual reactions)
		0	100.0	;	# 174 
		0	100.0	;	# 175 
		0	100.0	;	# 176 
		0	100.0	;	# 177 
	...
	species_bounds_array = [
		...
		0.0	0.0	;	# 140 OPEN_GENE_nsp1
		0.0	0.0	;	# 141 PROTEIN_nsp1
		0.0	0.0	;	# 142 RIBOSOME
		0.0	0.0	;	# 143 RIBOSOME_START_nsp1
		0.0	0.0	;	# 144 RNAP
		0.0	0.0	;	# 145 mRNA_nsp1
		0.0	0.0	;	# 146 tRNA_c
	];
	...
	objective_coefficient_array = [
		...
		0.0	;	# 167 transcriptional_initiation_nsp1::GENE_nsp1+RNAP --> OPEN_GENE_nsp1
		0.0	;	# 168 transcription_nsp1::OPEN_GENE_nsp1+183.0*M_gtp_c+231.0*M_ctp_c+101.0*M_utp_c+163.0*M_atp_c+678.0*M_h2o_c --> mRNA_nsp1+GENE_nsp1+RNAP+678.0*M_ppi_c
		0.0	;	# 169 mRNA_degradation_nsp1::mRNA_nsp1 --> 183.0*M_gmp_c+231.0*M_cmp_c+101.0*M_ump_c+163.0*M_amp_c
		0.0	;	# 170 translation_initiation_nsp1::mRNA_nsp1+RIBOSOME --> RIBOSOME_START_nsp1
		0.0	;	# 171 translation_nsp1::RIBOSOME_START_nsp1+450.0*M_gtp_c+450.0*M_h2o_c+8.0*M_ala_L_c_tRNA_c+6.0*M_arg_L_c_tRNA_c+13.0*M_asn_L_c_tRNA_c+17.0*M_asp_L_c_tRNA_c+2.0*M_cys_L_c_tRNA_c+14.0*M_glu_L_c_tRNA_c+8.0*M_gln_L_c_tRNA_c+20.0*M_gly_L_c_tRNA_c+9.0*M_his_L_c_tRNA_c+12.0*M_ile_L_c_tRNA_c+19.0*M_leu_L_c_tRNA_c+18.0*M_lys_L_c_tRNA_c+5.0*M_met_L_c_tRNA_c+12.0*M_phe_L_c_tRNA_c+10.0*M_pro_L_c_tRNA_c+9.0*M_ser_L_c_tRNA_c+15.0*M_thr_L_c_tRNA_c+M_trp_L_c_tRNA_c+10.0*M_tyr_L_c_tRNA_c+17.0*M_val_L_c_tRNA_c --> RIBOSOME+mRNA_nsp1+PROTEIN_nsp1+450.0*M_gdp_c+450.0*M_pi_c+225.0*tRNA_c
		0.0	;	# 172 tRNA_c_charging_M_ala_L_c_nsp1::8.0*M_ala_L_c+8.0*M_atp_c+8.0*tRNA_c+8.0*M_h2o_c --> 8.0*M_ala_L_c_tRNA_c+8.0*M_amp_c+8.0*M_ppi_c
		0.0	;	# 173 tRNA_c_charging_M_arg_L_c_nsp1::6.0*M_arg_L_c+6.0*M_atp_c+6.0*tRNA_c+6.0*M_h2o_c --> 6.0*M_arg_L_c_tRNA_c+6.0*M_amp_c+6.0*M_ppi_c
		0.0	;	# 174 tRNA_c_charging_M_asn_L_c_nsp1::13.0*M_asn_L_c+13.0*M_atp_c+13.0*tRNA_c+13.0*M_h2o_c --> 13.0*M_asn_L_c_tRNA_c+13.0*M_amp_c+13.0*M_ppi_c
		0.0	;	# 175 tRNA_c_charging_M_asp_L_c_nsp1::17.0*M_asp_L_c+17.0*M_atp_c+17.0*tRNA_c+17.0*M_h2o_c --> 17.0*M_asp_L_c_tRNA_c+17.0*M_amp_c+17.0*M_ppi_c
		0.0	;	# 176 tRNA_c_charging_M_cys_L_c_nsp1::2.0*M_cys_L_c+2.0*M_atp_c+2.0*tRNA_c+2.0*M_h2o_c --> 2.0*M_cys_L_c_tRNA_c+2.0*M_amp_c+2.0*M_ppi_c
		0.0	;	# 177 tRNA_c_charging_M_glu_L_c_nsp1::14.0*M_glu_L_c+14.0*M_atp_c+14.0*tRNA_c+14.0*M_h2o_c --> 14.0*M_glu_L_c_tRNA_c+14.0*M_amp_c+14.0*M_ppi_c
		0.0	;	# 178 tRNA_c_charging_M_gln_L_c_nsp1::8.0*M_gln_L_c+8.0*M_atp_c+8.0*tRNA_c+8.0*M_h2o_c --> 8.0*M_gln_L_c_tRNA_c+8.0*M_amp_c+8.0*M_ppi_c
		0.0	;	# 179 tRNA_c_charging_M_gly_L_c_nsp1::20.0*M_gly_L_c+20.0*M_atp_c+20.0*tRNA_c+20.0*M_h2o_c --> 20.0*M_gly_L_c_tRNA_c+20.0*M_amp_c+20.0*M_ppi_c
		0.0	;	# 180 tRNA_c_charging_M_his_L_c_nsp1::9.0*M_his_L_c+9.0*M_atp_c+9.0*tRNA_c+9.0*M_h2o_c --> 9.0*M_his_L_c_tRNA_c+9.0*M_amp_c+9.0*M_ppi_c
		0.0	;	# 181 tRNA_c_charging_M_ile_L_c_nsp1::12.0*M_ile_L_c+12.0*M_atp_c+12.0*tRNA_c+12.0*M_h2o_c --> 12.0*M_ile_L_c_tRNA_c+12.0*M_amp_c+12.0*M_ppi_c
		0.0	;	# 182 tRNA_c_charging_M_leu_L_c_nsp1::19.0*M_leu_L_c+19.0*M_atp_c+19.0*tRNA_c+19.0*M_h2o_c --> 19.0*M_leu_L_c_tRNA_c+19.0*M_amp_c+19.0*M_ppi_c
		0.0	;	# 183 tRNA_c_charging_M_lys_L_c_nsp1::18.0*M_lys_L_c+18.0*M_atp_c+18.0*tRNA_c+18.0*M_h2o_c --> 18.0*M_lys_L_c_tRNA_c+18.0*M_amp_c+18.0*M_ppi_c
		0.0	;	# 184 tRNA_c_charging_M_met_L_c_nsp1::5.0*M_met_L_c+5.0*M_atp_c+5.0*tRNA_c+5.0*M_h2o_c --> 5.0*M_met_L_c_tRNA_c+5.0*M_amp_c+5.0*M_ppi_c
		0.0	;	# 185 tRNA_c_charging_M_phe_L_c_nsp1::12.0*M_phe_L_c+12.0*M_atp_c+12.0*tRNA_c+12.0*M_h2o_c --> 12.0*M_phe_L_c_tRNA_c+12.0*M_amp_c+12.0*M_ppi_c
		0.0	;	# 186 tRNA_c_charging_M_pro_L_c_nsp1::10.0*M_pro_L_c+10.0*M_atp_c+10.0*tRNA_c+10.0*M_h2o_c --> 10.0*M_pro_L_c_tRNA_c+10.0*M_amp_c+10.0*M_ppi_c
		0.0	;	# 187 tRNA_c_charging_M_ser_L_c_nsp1::9.0*M_ser_L_c+9.0*M_atp_c+9.0*tRNA_c+9.0*M_h2o_c --> 9.0*M_ser_L_c_tRNA_c+9.0*M_amp_c+9.0*M_ppi_c
		0.0	;	# 188 tRNA_c_charging_M_thr_L_c_nsp1::15.0*M_thr_L_c+15.0*M_atp_c+15.0*tRNA_c+15.0*M_h2o_c --> 15.0*M_thr_L_c_tRNA_c+15.0*M_amp_c+15.0*M_ppi_c
		0.0	;	# 189 tRNA_c_charging_M_trp_L_c_nsp1::M_trp_L_c+M_atp_c+tRNA_c+M_h2o_c --> M_trp_L_c_tRNA_c+M_amp_c+M_ppi_c
		0.0	;	# 190 tRNA_c_charging_M_tyr_L_c_nsp1::10.0*M_tyr_L_c+10.0*M_atp_c+10.0*tRNA_c+10.0*M_h2o_c --> 10.0*M_tyr_L_c_tRNA_c+10.0*M_amp_c+10.0*M_ppi_c
		0.0	;	# 191 tRNA_c_charging_M_val_L_c_nsp1::17.0*M_val_L_c+17.0*M_atp_c+17.0*tRNA_c+17.0*M_h2o_c --> 17.0*M_val_L_c_tRNA_c+17.0*M_amp_c+17.0*M_ppi_c
		0.0	;	# 192 tRNA_c_exchange::[] --> tRNA_c
		0.0	;	# 193 tRNA_c_exchange_reverse::tRNA_c --> []
		0.0	;	# 194 PROTEIN_export_nsp1::PROTEIN_nsp1 --> []
	...
	list_of_reaction_strings = [
		...
		"transcriptional_initiation_nsp1::GENE_nsp1+RNAP --> OPEN_GENE_nsp1"
		"transcription_nsp1::OPEN_GENE_nsp1+183.0*M_gtp_c+231.0*M_ctp_c+101.0*M_utp_c+163.0*M_atp_c+678.0*M_h2o_c --> mRNA_nsp1+GENE_nsp1+RNAP+678.0*M_ppi_c"
		"mRNA_degradation_nsp1::mRNA_nsp1 --> 183.0*M_gmp_c+231.0*M_cmp_c+101.0*M_ump_c+163.0*M_amp_c"
		"translation_initiation_nsp1::mRNA_nsp1+RIBOSOME --> RIBOSOME_START_nsp1"
		"translation_nsp1::RIBOSOME_START_nsp1+450.0*M_gtp_c+450.0*M_h2o_c+8.0*M_ala_L_c_tRNA_c+6.0*M_arg_L_c_tRNA_c+13.0*M_asn_L_c_tRNA_c+17.0*M_asp_L_c_tRNA_c+2.0*M_cys_L_c_tRNA_c+14.0*M_glu_L_c_tRNA_c+8.0*M_gln_L_c_tRNA_c+20.0*M_gly_L_c_tRNA_c+9.0*M_his_L_c_tRNA_c+12.0*M_ile_L_c_tRNA_c+19.0*M_leu_L_c_tRNA_c+18.0*M_lys_L_c_tRNA_c+5.0*M_met_L_c_tRNA_c+12.0*M_phe_L_c_tRNA_c+10.0*M_pro_L_c_tRNA_c+9.0*M_ser_L_c_tRNA_c+15.0*M_thr_L_c_tRNA_c+M_trp_L_c_tRNA_c+10.0*M_tyr_L_c_tRNA_c+17.0*M_val_L_c_tRNA_c --> RIBOSOME+mRNA_nsp1+PROTEIN_nsp1+450.0*M_gdp_c+450.0*M_pi_c+225.0*tRNA_c"
		"tRNA_c_charging_M_ala_L_c_nsp1::8.0*M_ala_L_c+8.0*M_atp_c+8.0*tRNA_c+8.0*M_h2o_c --> 8.0*M_ala_L_c_tRNA_c+8.0*M_amp_c+8.0*M_ppi_c"
		"tRNA_c_charging_M_arg_L_c_nsp1::6.0*M_arg_L_c+6.0*M_atp_c+6.0*tRNA_c+6.0*M_h2o_c --> 6.0*M_arg_L_c_tRNA_c+6.0*M_amp_c+6.0*M_ppi_c"
		"tRNA_c_charging_M_asn_L_c_nsp1::13.0*M_asn_L_c+13.0*M_atp_c+13.0*tRNA_c+13.0*M_h2o_c --> 13.0*M_asn_L_c_tRNA_c+13.0*M_amp_c+13.0*M_ppi_c"
		"tRNA_c_charging_M_asp_L_c_nsp1::17.0*M_asp_L_c+17.0*M_atp_c+17.0*tRNA_c+17.0*M_h2o_c --> 17.0*M_asp_L_c_tRNA_c+17.0*M_amp_c+17.0*M_ppi_c"
		"tRNA_c_charging_M_cys_L_c_nsp1::2.0*M_cys_L_c+2.0*M_atp_c+2.0*tRNA_c+2.0*M_h2o_c --> 2.0*M_cys_L_c_tRNA_c+2.0*M_amp_c+2.0*M_ppi_c"
		"tRNA_c_charging_M_glu_L_c_nsp1::14.0*M_glu_L_c+14.0*M_atp_c+14.0*tRNA_c+14.0*M_h2o_c --> 14.0*M_glu_L_c_tRNA_c+14.0*M_amp_c+14.0*M_ppi_c"
		"tRNA_c_charging_M_gln_L_c_nsp1::8.0*M_gln_L_c+8.0*M_atp_c+8.0*tRNA_c+8.0*M_h2o_c --> 8.0*M_gln_L_c_tRNA_c+8.0*M_amp_c+8.0*M_ppi_c"
		"tRNA_c_charging_M_gly_L_c_nsp1::20.0*M_gly_L_c+20.0*M_atp_c+20.0*tRNA_c+20.0*M_h2o_c --> 20.0*M_gly_L_c_tRNA_c+20.0*M_amp_c+20.0*M_ppi_c"
		"tRNA_c_charging_M_his_L_c_nsp1::9.0*M_his_L_c+9.0*M_atp_c+9.0*tRNA_c+9.0*M_h2o_c --> 9.0*M_his_L_c_tRNA_c+9.0*M_amp_c+9.0*M_ppi_c"
		"tRNA_c_charging_M_ile_L_c_nsp1::12.0*M_ile_L_c+12.0*M_atp_c+12.0*tRNA_c+12.0*M_h2o_c --> 12.0*M_ile_L_c_tRNA_c+12.0*M_amp_c+12.0*M_ppi_c"
		"tRNA_c_charging_M_leu_L_c_nsp1::19.0*M_leu_L_c+19.0*M_atp_c+19.0*tRNA_c+19.0*M_h2o_c --> 19.0*M_leu_L_c_tRNA_c+19.0*M_amp_c+19.0*M_ppi_c"
		"tRNA_c_charging_M_lys_L_c_nsp1::18.0*M_lys_L_c+18.0*M_atp_c+18.0*tRNA_c+18.0*M_h2o_c --> 18.0*M_lys_L_c_tRNA_c+18.0*M_amp_c+18.0*M_ppi_c"
		"tRNA_c_charging_M_met_L_c_nsp1::5.0*M_met_L_c+5.0*M_atp_c+5.0*tRNA_c+5.0*M_h2o_c --> 5.0*M_met_L_c_tRNA_c+5.0*M_amp_c+5.0*M_ppi_c"
		"tRNA_c_charging_M_phe_L_c_nsp1::12.0*M_phe_L_c+12.0*M_atp_c+12.0*tRNA_c+12.0*M_h2o_c --> 12.0*M_phe_L_c_tRNA_c+12.0*M_amp_c+12.0*M_ppi_c"
		"tRNA_c_charging_M_pro_L_c_nsp1::10.0*M_pro_L_c+10.0*M_atp_c+10.0*tRNA_c+10.0*M_h2o_c --> 10.0*M_pro_L_c_tRNA_c+10.0*M_amp_c+10.0*M_ppi_c"
		"tRNA_c_charging_M_ser_L_c_nsp1::9.0*M_ser_L_c+9.0*M_atp_c+9.0*tRNA_c+9.0*M_h2o_c --> 9.0*M_ser_L_c_tRNA_c+9.0*M_amp_c+9.0*M_ppi_c"
		"tRNA_c_charging_M_thr_L_c_nsp1::15.0*M_thr_L_c+15.0*M_atp_c+15.0*tRNA_c+15.0*M_h2o_c --> 15.0*M_thr_L_c_tRNA_c+15.0*M_amp_c+15.0*M_ppi_c"
		"tRNA_c_charging_M_trp_L_c_nsp1::M_trp_L_c+M_atp_c+tRNA_c+M_h2o_c --> M_trp_L_c_tRNA_c+M_amp_c+M_ppi_c"
		"tRNA_c_charging_M_tyr_L_c_nsp1::10.0*M_tyr_L_c+10.0*M_atp_c+10.0*tRNA_c+10.0*M_h2o_c --> 10.0*M_tyr_L_c_tRNA_c+10.0*M_amp_c+10.0*M_ppi_c"
		"tRNA_c_charging_M_val_L_c_nsp1::17.0*M_val_L_c+17.0*M_atp_c+17.0*tRNA_c+17.0*M_h2o_c --> 17.0*M_val_L_c_tRNA_c+17.0*M_amp_c+17.0*M_ppi_c"
		"tRNA_c_exchange::[] --> tRNA_c"
		"tRNA_c_exchange_reverse::tRNA_c --> []"
		"PROTEIN_export_nsp1::PROTEIN_nsp1 --> []"
